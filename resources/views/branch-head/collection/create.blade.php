<x-admin-layout>
    @section('title')
        Create Collection <a href="{{ url()->previous() }}" class="btn-link btn-sm btn" >Go Back</a>
    @endsection
    ...
    @section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{route('branch-head.collection.store')}}" method="POST">
                        @csrf
                        @method("POST")
                        <div class="card">
                           ...
                           <div class="card-body">
                                <div class="row mt-3">
                                    <div class="col-4 mb-3">
                                        <x-input id="collection_date" name="collection_date" type="date" placeholder="Collection Date" value="{{ old('collection_date') }}">
                                        ...
                                        <div class="form-floating">
                                            <select name="cashier" class="form-select" id="">
                                                @foreach ($cashiers as $cashier)
                                                    <option value="{{$cashier->id}}">{{ucwords($cashier->lastname." ".$cashier->firstname." ".$cashier->middlename)}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-4 mb-3">
                                        <x-input id="gross" name="gross" type="number" step="0.01" placeholder="Gross" value="{{ old('gross') }}">
                                            <x-validation-error name="gross"></x-validation-error>
                                        </x-input>
                                    </div>
                                    <div class="col-4 mb-3">
                                        <x-input id="paid_in" name="paid_in" type="number" step="0.01" placeholder="Paid In" value="{{ old('paid_in') }}">
                                            <x-validation-error name="paid_in"></x-validation-error>
                                        </x-input>
                                    </div>
                                    <div class="col-4 mb-3">
                                        <x-input id="purchase_order" name="purchase_order" type="number" placeholder="Purchase Order" value="{{ old('purchase_order') }}">
                                            <x-validation-error name="purchase_order"></x-validation-error>
                                        </x-input>
                                    </div>
                                    <div class="col-4 mb-3">
                                        <x-input id="paid_out" name="paid_out" type="number" step="0.01" placeholder="Paid Out" value="{{ old('paid_out') }}">
                                            <x-validation-error name="paid_out"></x-validation-error>
                                        </x-input>
                                    </div>
                                    <div class="col-4 mb-3">
                                        <x-input id="redeem" name="redeem" type="number" step="0.01" placeholder="Redeem" value="{{ old('redeem') }}">
                                            <x-validation-error name="redeem"></x-validation-error>
                                        </x-input>
                                    </div>
                                    <div class="col-4 mb-3">
                                        <x-input id="discount" name="discount" type="number" step="0.01" placeholder="Discount" value="{{ old('discount') }}">
                                            <x-validation-error name="discount"></x-validation-error>
                                        </x-input>
                                    </div>
                                    <div class="col-4 mb-3">
                                        <x-input id="lubes" name="lubes" type="number" step="0.01" placeholder="Lubes" value="{{ old('lubes') }}">
                                            <x-validation-error name="lubes"></x-validation-error>
                                        </x-input>
                                    </div>

                                    <div class="col-4 mb-3">
                                        <x-input id="cheque" name="cheque" type="number" step="0.01" placeholder="Cheque" value="{{ old('cheque') }}">
                                            <x-validation-error name="cheque"></x-validation-error>
                                        </x-input>
                                    </div>
                                    <div class="col-4 mb-3">
                                        <x-input id="cash_on_hand" name="cash_on_hand" type="number" step="0.01" placeholder="Cash On Hand" value="{{ old('cash_on_hand') }}">
